const contriesEl=document.getElementById('contries');
const darkModeEl=document.getElementById('dark-mode');
const headerEl=document.querySelector('header');
const homeEl=document.querySelector('.home');
const contryEl=document.querySelector('.contry');
...
let contries=[
  ...
  function darkMode(dark_mode){
    let contrysEl=document.querySelectorAll('.contry')
    contrysEl.forEach(function(contry) {
        if(dark_mode=="light"){
            contry.classList.add('light')
            contry.classList.remove('dark')
                }else if(dark_mode=="dark") {
                    contry.classList.remove('light')
                    contry.classList.add('dark')
                }
    });
    if(dark_mode=="light"){
headerEl.classList.add('light')
selectEl.classList.add('light')
searchEl.classList.add('light')
homeEl.classList.add('light')
darkModeEl.classList.add('light')

headerEl.classList.remove('dark')
selectEl.classList.remove('dark')
searchEl.classList.remove('dark')
homeEl.classList.remove('dark')
darkModeEl.classList.remove('dark')
searchEl.querySelector('input').classList.remove('dark')


    }else {
        headerEl.classList.add('dark')
selectEl.classList.add('dark')
searchEl.classList.add('dark')
homeEl.classList.add('dark')
darkModeEl.classList.add('dark')
searchEl.querySelector('input').classList.add('dark')

headerEl.classList.remove('light')
selectEl.classList.remove('light')
searchEl.classList.remove('light')
homeEl.classList.remove('light')
darkModeEl.classList.remove('light')

    }
}
function displayContries(contries){
    contriesEl.innerHTML=""
   let dark_mode=localStorage.getItem("darkMode") || "dark"
    ...
    contries.forEach((contry) => {
        ...
        <a href="./detail.html?name=${contry.name}">
          <div class="contry dark">
            ...
            <div class="info">
              <div class="title">${contry.name}</div>
              <div class="content">
                <p class="population">
                  Population : <span id="pop">${contry.population}</span>
                </p>
                <p class="region">Region : <span id="reg">${contry.region}</span></p>
                <p class="capital">Capital : <span id="cap">${contry.capital}</span></p>
              </div>
            </div>
    ...
    contriesEl.innerHTML=html
}




// dark mode fonctionality
...
// on page loaded
window.addEventListener('DOMContentLoaded', displayContries(contries));


// filtre fonctionality
selectEl.addEventListener('change', function (e) {
   let regionValue=e.target.value
   let filtredContries=contries.filter((contry) => {
    return contry.region==regionValue
   })
   displayContries(filtredContries)
});
...
searchEl.addEventListener('input', function (e) {
   ...
   let searchedContries=contries.filter((contry) => {
    return contry.name.toLowerCase().includes(serachValue.toLowerCase())
   })
   displayContries(searchedContries)
});
